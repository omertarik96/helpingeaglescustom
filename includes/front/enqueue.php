...
//    wp_enqueue_style('lato');
    ...
    wp_register_script('he_bootstrap_js', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array(), false, true);
//    wp_register_script('he_plugins', get_template_directory_uri() . '/assets/js/plugins.js', array(), false, true);
//    wp_register_script('he_bskit', get_template_directory_uri() . '/assets/js/bskit-scripts.js', array(), false, true);
